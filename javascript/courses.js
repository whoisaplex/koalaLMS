...
for(let i = 0; i < users.length; i++){
  if(users[i].username === 'alexander'){
  for(let z = 0; z < 1; z++){
      for(let x = 0; x < users[i].all_courses[0].ongoing.length; x++){
        if(users[i].all_courses[0].ongoing[x].name === page){
            document.getElementById('hubba').innerHTML = '<h2>'+users[i].all_courses[0].ongoing[x].name+'</h2><h3>Tempo: '+users[i].all_courses[0].ongoing[x].tempo+' Teacher: '+users[i].all_courses[0].ongoing[x].teacher+'</h3><hr><h4>Description</h4><p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p><h5><a href="#">Read full description</a></h5>';
        }
      }
      for(let x = 0; x < users[i].all_courses[1].upcoming.length; x++){
        if(users[i].all_courses[1].upcoming[x].name === page){
          document.getElementById('hubba').innerHTML = '<h2>'+users[i].all_courses[1].upcoming[x].name+'</h2><h3>Tempo: '+users[i].all_courses[1].upcoming[x].tempo+' Teacher: '+users[i].all_courses[1].upcoming[x].teacher+'</h3><hr><h4>Description</h4><p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p><h5><a href="#">Read full description</a></h5>';
        }
      }
    }
  }
